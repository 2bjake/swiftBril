...
//print(SSA.findDominators(cfg: ControlFlowGraph(function: program.functions[0])))
print(SSA.findImmediateDominators(cfg: ControlFlowGraph(function: program.functions[0])))
